...
public class CodiceFiscale {
	...
	private boolean controllaLunghezza() {
		...
		//Il controllo è utile anche per evitare errori di tipo out of bounds
		this.setNome();
		this.setCognome();
		this.setAnno();
		this.setMese();
	...
	//Controlla ogni posizione in modo da vedere se è presente un numero o un carattere
	...
	//Controlla la correttezza dell'ultima lettera
